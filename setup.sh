...
# set virtual audio to start on boot
mkdir -p /home/syn/.config/pulse/
cat > /home/syn/.config/pulse/default.pa <<EOL
...
# install the stuff
apt update
apt -y install openbox obconf ffmpeg tigervnc-standalone-server tigervnc-common xdg-utils wmctrl xterm git libnss3 xdotool x11-xserver-utils feh pulseaudio pulseaudio-utils alsa-utils
